...
from apps.landlords.forms import PropertyMediaFormSet
...
def list_amenities(request):
    ...
    return render(request, 'landlords/amenity_list.html', {'amenities': page_obj})
...
def list_landlord_subscription(request):
    ...
    return render(request, 'landlords/landlord_subscription_list.html', {'subscription': subscription_qs})
...
def property_detail(request, slug):
    ...
    return render(request, "landlords/property_detail_admin.html", context)
...
def list_properties_related_landlords(request):
    ...
    return render(request, "landlords/properties_list.html", context)
...
def create_amenity(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('landlords:amenity_list')
        else:
            messages.error(request, 'Error creating amenity.')
    else:
        form = AmenityForm()
    return render(request, 'landlords/amenity_form.html', {'form': form})
...
def update_amenity(request, amenity_id: str):
    ...
    return render(request, 'landlords/amenity_form.html', {'form': form, 'amenity': amenity})
...
def list_properties(request):
    ...
    page = request.GET.get('page')
    page_obj = paginator.get_page(page)
    return render(request, 'landlords/property_list.html', {'properties': page_obj})
...
def create_property(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and media_formset.is_valid():
            ...
            return redirect('landlords:property_list')
        else:
    ...
    return render(request, 'landlords/property_form.html', {
        'form': form,
...
def verify_property(request, property_id: str):
    ...
    return render(request, 'landlords/property_verification.html', {'form': form, 'property': property_obj})
